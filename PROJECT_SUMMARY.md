# PlanA LMS - Project Summary

## Overview
A **high-speed, project-based Learning Management System** designed for the Nigerian gig economy. Zero theory, real projects, get gig-ready in 4-12 weeks.

### 🎨 Theme: Orange & Blue (Solid Colors)
- Primary Orange: `#FF6B35` - Actions, progress, success
- Primary Blue: `#2E5EFF` - Information, navigation, links
- No gradients - clean, fast, professional
